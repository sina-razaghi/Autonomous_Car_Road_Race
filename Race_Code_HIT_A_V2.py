...
try:
    while(True):
        ...
        if counter > 4 :
            ...
            up_mask, down_mask  = 110, 190
            lane_contours, _ = cv2.findContours(yellow_mask[up_mask:down_mask,:], cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
            ...
            if Debugging:
                ...
                _frame = cv2.rectangle(_frame,(0,up_mask),(256,down_mask),(0,255,0),1)
